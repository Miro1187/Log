...
namespace DbAccess
{
    ...
    {
        private LogisticsContext Context { get; }

        public DBAccess(LogisticsContext _context)
        {
        ...
        {
            Context.LogisticsCenters.Add(new LogisticsCenter
            {
